    ...
    <section class="hero">
      <div class="container hero-grid">
        <div>
          ...
          <p class="lead">استأجري حقائب وأحذية وساعات ومجوهرات من أرقى الدور العالمية، موثّقة ومؤمّنة ومعقّمة، تصلك لبابك خلال ٢٤ ساعة. بدّلي كل شهر، وعيشي الفخامة بلا التزام.</p>
          <div class="hero-cta">
